...
<img width="668" height="1004" alt="model" src="https://github.com/user-attachments/assets/483139ee-098a-41b9-9210-0d21536e7583" />
...
- `src`: the folder contain the source code of the project, include the notebooks for training and inference with each component of the model.
